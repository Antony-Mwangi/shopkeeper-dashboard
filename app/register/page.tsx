  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-4 py-12">
        <Link 
          href="/" 
          className="mb-8 flex items-center gap-2 text-slate-500 hover:text-blue-600 transition group"
        >
        ...
        <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl w-full max-w-md border border-slate-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-5 mt-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  placeholder="John Doe"
                  className="w-full pl-10 p-3 rounded-xl border border-slate-200 bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 text-white py-3 rounded-xl font-bold hover:bg-blue-700 transition flex justify-center items-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed shadow-lg shadow-blue-200 hover:shadow-xl"
            >
              {loading ? <Loader2 size={18} className="animate-spin" /> : "Get Started"}
            </button>
          </form>
          ...
          <p className="text-sm text-center text-slate-500 mt-6">
            Already have an account?{" "}
            <Link href="/login" className="text-blue-600 font-bold hover:underline hover:text-blue-700 transition">
              Sign in
            </Link>
          </p>
        </div>
      ...
      {/* Footer - Imported like in dashboard page */}
      <Footer />
    </div>
  );
}