      ...
      >
        <div className="flex items-center justify-center h-16 border-b relative">
          <div className="flex items-center gap-2">
            ...
            {sidebarOpen && <span className="font-bold text-lg text-gray-800">ShopFlow</span>}
          </div>
          <button
        ...
        <nav className="flex-1 p-4 space-y-2 text-gray-700">
          ...
          <Link href="/logout" className="flex items-center gap-3 p-3 rounded-lg hover:bg-red-100 text-red-600">
            ...
            <form onSubmit={updateProfile} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-lg p-3 text-gray-800 bg-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 outline-none"
                />
              </div>
